  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li><a href="pages/tables/data.php"><i class="fa fa-table"></i> <span>View Data</span></a></li>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				$qGetData = "SELECT name, surname, birthday, university FROM STUDENTS S";
				$runquery = mysqli_query($dbc, $qGetData) or die('Error: '. mysql_error());
				
				
				
				while($fetchdata = mysqli_fetch_array($runquery, MYSQLI_ASSOC)){
					
				
				array_push($name, $fetchdata['name']);
				array_push($surname, $fetchdata['surname']);
				array_push($birthday, $fetchdata['birthday']);
				array_push($university, $fetchdata['university']);
				...
				for($index = 0; $index < sizeof($name); $index++){
					...
					echo "<tr><td align=\'center\'>".$name[$index]."</td>";
					echo "<td align=\'center\'>".$surname[$index]."</td>";
					echo "<td align=\'center\'>".$birthday[$index]."</td>";
					echo "<td align=\'center\'>".$university[$index]."</td></tr>";
		  ...
		  <div class="box">
            <div class="box-header">
              <h3 class="box-title">Students grouped by Age and University</h3>
            </div>
            <!-- /.box-header -->
		  ...
		  <div class="box">
            ...
            <div class="box-header">
              <h3 class="box-title">Total number of students in each University</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example4" class="table table-bordered table-striped">
				...
				$qGetData = "SELECT university, COUNT(name) AS count FROM STUDENTS S GROUP BY university";
				$runquery = mysqli_query($dbc, $qGetData) or die('Error: '. mysql_error());
				...
				array_push($count, $fetchdata['count']);
				array_push($university, $fetchdata['university']);
				
				}
				
				
				for($index = 0; $index < sizeof($university); $index++){
					
					echo "<tr><td align=\'center\'>".$university[$index]."</td>";
					echo "<td align=\'center\'>".$count[$index]."</td></tr>";
